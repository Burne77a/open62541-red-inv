...
# open62541 - red-inv fork
This is a fork of open62541 (http://open62541.org>). The intention of the fork was to try out some scenarios related to redundancy. In other words, this is just a playground and a way to share the changes with those interested.  
Some of the differences include:
A rudimentary support for sequence number adherence has been added.
Two example files for a simplistic publisher and subscriber scenario have been added. Note that these example files are not built when building the examples; one has to build them explicitly. 


This is just a first try/atemp on these scenarios. 
Below is the orignal, forked readme. 
