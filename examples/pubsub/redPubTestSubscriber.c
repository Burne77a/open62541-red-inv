...
int main(int argc, char **argv) {
    ...
    UA_NetworkAddressUrlDataType networkAddressUrl = {UA_STRING("192.168.44.102") , UA_STRING("opc.udp://192.168.44.102:4840/")};
#else
    UA_NetworkAddressUrlDataType networkAddressUrl = {UA_STRING("192.168.44.102") , UA_STRING("opc.udp://224.0.0.22:4840/")};
#endif
    if(argc > 1) {
